...
<?php include 'header.php'; ?>
    ...
    <div class="container">
        ...
        <div class="slider" id="slider">
            <div class="slides-container" id="slidesContainer">
                <div class="slide">
                    ...
                    <span class="slider-type">ГУБЕРНАТОР</span>
                    <p class="slider-text">Губернатор наградил бывшего главу водоканала</p>
                    <span class="slider-subhead">18 июля, 11:10</span>
                </div>
                <div class="slide">
                    <img src="media/img2.png" class="slider-img">
                    <div style="height: 20px;"></div>
                    <span class="slider-type">ТЕМА 2</span>
                    <p class="slider-text">Описание темы 2</p>
                    <span class="slider-subhead">19 июля, 12:00</span>
                </div>
                <div class="slide">
                    <img src="media/img3.png" class="slider-img">
                    <div style="height: 20px;"></div>
                    <span class="slider-type">ТЕМА 3</span>
                    <p class="slider-text">Описание темы 3</p>
                    <span class="slider-subhead">20 июля, 13:00</span>
                </div>
                <div class="slide">
                    <img src="media/img3.png" class="slider-img">
                    <div style="height: 20px;"></div>
                    <span class="slider-type">ТЕМА 4</span>
                    <p class="slider-text">Описание темы 4</p>
                    <span class="slider-subhead">21 июля, 14:00</span>
                </div>
                <div class="slide">
                    <img src="media/img3.png" class="slider-img">
                    <div style="height: 20px;"></div>
        ...
        <script>
            let currentIndex = 0;
            const slidesToShow = 3; // Количество карточек, отображаемых одновременно
            const slidesContainer = document.getElementById('slidesContainer');
            const slides = document.querySelectorAll('.slide');
            const totalSlides = slides.length;

            function showSlide(index) {
                currentIndex = (index + totalSlides+2) % totalSlides;
